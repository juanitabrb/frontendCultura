...
export class SeguridadService {
  ...
  guardarDatosSesion(datosSesion: any) {
    let sesionActual = localStorage.getItem('sesion');
      let data: Usuario = {
        ...
        id_rol: datosSesion.usuario.id_rol,
  ...
  logout() {
    ...
    return this.http.post<Usuario>(`${environment.url_backend}/logout`, {});
  ...
  verificarRolSesion(roleId):Boolean{
    let currentSesion=JSON.parse(this.getDatosSesion());
    return(currentSesion.id_rol==roleId);
  }
}
